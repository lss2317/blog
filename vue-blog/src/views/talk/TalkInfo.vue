<template>
  <div>
    ...
    <v-card class="blog-container">
      ...
      <!-- 评论 -->
      <Comment ref="talkComment" :type="commentType" @getCommentCount="getCommentCount"/>
    </v-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    getTalkById() {
      this.axios
          .get("/api/talk/" + this.$route.params.talkId)
          .then(res => {
            this.$refs.talkComment.getPostUserId(res.data.data.userId)
